...
module.exports = function exports(options) {
  ...
  const softwareReset = function softwareReset(cb) {
  ...
  const setPWMFreq = function setPWMFreq(freq, cb) {
  ...
  const getPWMFreq = function getPWMFreq(cb) {
  ...
  const setPWM = function setPWM(channel, on, off, cb) {
  ...
  const setAllPWM = function setAllPWM(on, off, cb) {
    onoffspec.validate({ on, off }, errHdlr);
  ...
  const setPin = function setPin(channel, state, cb) {
    channelspec.validate({ channel }, errHdlr);
