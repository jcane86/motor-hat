...
describe('lib/stepper.js', () => {
  ...
  it('should fail without speed', () => {
    (function () {
      stepper({ pwm, pins: ports[0] }).stepSync('fwd', 4);
    }).should.throw();
  });

  it('should initialize', () => {
    (function () {
      stepper({ pwm, pins: ports[0] });
    }).should.not.throw();
  });
  ...
  describe('setSteps()', () => {
    it('should validate steps', () => {
      (function () {
        stepper({ pwm, pins: ports[0] }).setSteps('test');
      }).should.throw();

      (function () {
        stepper({ pwm, pins: ports[0] }).setSteps(64 * 32);
      }).should.not.throw();
    });
  ...
  describe('setSpeed()', () => {
    it('should validate speed', () => {
      (function () {
        stepper({ pwm, pins: ports[0] }).setSpeed('test');
      }).should.throw();

      (function () {
        stepper({ pwm, pins: ports[0] }).setSpeed({ rpm: 200 });
      }).should.not.throw();
    });
